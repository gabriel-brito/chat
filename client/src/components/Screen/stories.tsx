...
const id = v4()
const messages = [
  { message: 'Hello there!', id, user: 'Gabriel' },
  { message: 'Hello!', id: 'id-2', user: 'Bot-1567' },
  { message: 'How are you doing today?', id, user: 'Gabriel' },
  {
    message: `I'm really good! and what about you?`,
    id: 'id-2',
    user: 'Bot-1567'
  },
  { message: `I'm great, thanks!`, id, user: 'Gabriel' },
  {
...
export const WithMessages: Story<ScreenProps> = () => (
  <div style={{ maxWidth: '35em', margin: '0 auto', height: '100vh' }}>
    <Screen userId={id} messages={messages} />
  </div>
)
